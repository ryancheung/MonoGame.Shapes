...
namespace MonoGame.Shapes
{
    ...
    {
        public static Rectangle? PixelSourceRectangle;
        ...
        public static Texture2D PixelTexture {
            ...
            set
            {
                if (_PixelTexture != null && _PixelTexture.Width == 1 && _PixelTexture.Height == 1)
        ...
        private static void DrawPolygonEdge(SpriteBatch spriteBatch, Texture2D texture, Vector2 point1, Vector2 point2, Color color, float thickness, int layerDepth)
        {
            ...
            spriteBatch.Draw(texture, point1, PixelSourceRectangle, color, angle, Vector2.Zero, scale, SpriteEffects.None, layerDepth);
        }
        ...
        public static void DrawRectangle(this SpriteBatch spriteBatch, Rectangle rectangle, Color color, float thickness = 1f, int layerDepth = 0)
        {
            ...
            spriteBatch.Draw(texture, topLeft, PixelSourceRectangle, color, 0f, Vector2.Zero, horizontalScale, SpriteEffects.None, layerDepth);
            spriteBatch.Draw(texture, topLeft, PixelSourceRectangle, color, 0f, Vector2.Zero, verticalScale, SpriteEffects.None, layerDepth);
            spriteBatch.Draw(texture, topRight, PixelSourceRectangle, color, 0f, Vector2.Zero, verticalScale, SpriteEffects.None, layerDepth);
            spriteBatch.Draw(texture, bottomLeft, PixelSourceRectangle, color, 0f, Vector2.Zero, horizontalScale, SpriteEffects.None, layerDepth);
        }
        ...
        public static void DrawPoint(this SpriteBatch spriteBatch, Vector2 position, Color color, float size = 1f, int layerDepth = 0)
        {
            ...
            spriteBatch.Draw(GetOrCreateTexture(spriteBatch), position + offset, PixelSourceRectangle, color, 0f, Vector2.Zero, scale, SpriteEffects.None, layerDepth);
        }
